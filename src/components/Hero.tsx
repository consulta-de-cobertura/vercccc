          ...
          <div className="mt-1 md:hidden">
            <div className="p-3">
              ...
              <div className="mt-4 text-center">
                <p className="text-sm text-gray-300">Descubra agora como mais de 100.000 brasileiros já estão usando internet ilimitada de verdade e ainda transformando sua conexão em uma fonte de renda extra recorrente com o nosso programa PBI</p>
              </div>
            </div>
          </div>
        </div>
